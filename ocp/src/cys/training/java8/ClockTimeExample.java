...
//        getLocalDate();
	...
	private static void getLocalTime() {
		...
		System.out.println("Get LocalTime" + localTime);
		System.out.println("Get LocalTime FroClock" + localTimeFromClock);
	}
	...
	private static void getLocalDateTime() {
		...
		System.out.println("LocalDateTimeFromClock" + localDateTimeFromClock);
	}
